...
------------ | ------------- | ------------- | -------------
*JourneyApi* | [**create_journey_action**](docs/JourneyApi.md#create_journey_action) | **POST** /v1/journey/actions | Create/Replace Journey Action.
*JourneyApi* | [**create_profile_view_template**](docs/JourneyApi.md#create_profile_view_template) | **POST** /v1/journey/views/templates | Create Profile View Template
*JourneyApi* | [**create_view**](docs/JourneyApi.md#create_view) | **POST** /v1/journey/views | Starts job to generate Progressive Profile View for a person.
*JourneyApi* | [**delete_journey_action**](docs/JourneyApi.md#delete_journey_action) | **DELETE** /v1/journey/actions/{id} | Soft delete Journey Action.
*JourneyApi* | [**delete_profile_view_template**](docs/JourneyApi.md#delete_profile_view_template) | **DELETE** /v1/journey/views/templates | Delete Profile View Template
*JourneyApi* | [**get_journey_action**](docs/JourneyApi.md#get_journey_action) | **GET** /v1/journey/actions/{id} | Get specific Journey Action.
*JourneyApi* | [**get_journey_action_list**](docs/JourneyApi.md#get_journey_action_list) | **GET** /v1/journey/actions | Get all Journey Actions.
*JourneyApi* | [**get_profile_view_templates**](docs/JourneyApi.md#get_profile_view_templates) | **GET** /v1/journey/views/templates | Get Profile View Templates
*JourneyApi* | [**get_report_by_name**](docs/JourneyApi.md#get_report_by_name) | **GET** /v1/journey/reports/{reportname} | Get Report by Name
*JourneyApi* | [**get_view_status**](docs/JourneyApi.md#get_view_status) | **GET** /v1/journey/views | Get the status of a Progressive Profile View Job.
*JourneyApi* | [**post_events**](docs/JourneyApi.md#post_events) | **POST** /v1/journey/events | Post Events
*JourneyApi* | [**profile_builder**](docs/JourneyApi.md#profile_builder) | **POST** /v1/journey/profileview | A Profile is a bespoke view of a customer&#x27;s journey.
*JourneyApi* | [**read_events**](docs/JourneyApi.md#read_events) | **GET** /v1/journey/events | Read Events
*JourneyApi* | [**read_events_by_identity**](docs/JourneyApi.md#read_events_by_identity) | **GET** /v1/journey/events/{identity} | Read Events By Identity
*JourneyApi* | [**read_streams**](docs/JourneyApi.md#read_streams) | **GET** /v1/journey/streams | Read Streams
*JourneyApi* | [**read_streams_by_person**](docs/JourneyApi.md#read_streams_by_person) | **GET** /v1/journey/streams/{person} | Read Streams by Person
