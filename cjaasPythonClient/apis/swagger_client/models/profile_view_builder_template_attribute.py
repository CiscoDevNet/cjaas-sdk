...
class ProfileViewBuilderTemplateAttribute(object):
    ...
    def __init__(self, version=None, event=None, metadata=None, limit=None, display_name=None, aggregation_mode=None, verbose=None):  # noqa: E501
    ...
    @property
    def verbose(self):
        """Gets the verbose of this ProfileViewBuilderTemplateAttribute.  # noqa: E501

        If set to true, indicates that the matching Journey Events to be included in the response as well.  # noqa: E501

        :return: The verbose of this ProfileViewBuilderTemplateAttribute.  # noqa: E501
        :rtype: bool
        """
    ...
    def verbose(self, verbose):
        """Sets the verbose of this ProfileViewBuilderTemplateAttribute.

        If set to true, indicates that the matching Journey Events to be included in the response as well.  # noqa: E501

        :param verbose: The verbose of this ProfileViewBuilderTemplateAttribute.  # noqa: E501
        :type: bool
        """
