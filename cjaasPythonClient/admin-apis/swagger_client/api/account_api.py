...
class AccountApi(object):
    ...
    def rotate_app_key_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `rotate_app_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/organizations/apps/{appname}/key', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_app_attributes(self, authorization, **kwargs):  # noqa: E501
        """Update App Attributes  # noqa: E501

        Updates an Apps Attributes  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_app_attributes(authorization, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: Common Identity Bearer Token (required)
        :return: HttpSimpleMessageObjectResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_app_attributes_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.update_app_attributes_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def update_app_attributes_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """Update App Attributes  # noqa: E501

        Updates an Apps Attributes  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_app_attributes_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_app_attributes" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `update_app_attributes`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/organizations/apps/{appname}/attributes', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
