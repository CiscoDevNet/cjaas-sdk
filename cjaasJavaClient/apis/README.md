...
------------ | ------------- | ------------- | -------------
*JourneyApi* | [**createJourneyAction**](docs/JourneyApi.md#createJourneyAction) | **POST** /v1/journey/actions | Create/Replace Journey Action.
*JourneyApi* | [**createProfileViewTemplate**](docs/JourneyApi.md#createProfileViewTemplate) | **POST** /v1/journey/views/templates | Create Profile View Template
*JourneyApi* | [**createView**](docs/JourneyApi.md#createView) | **POST** /v1/journey/views | Starts job to generate Progressive Profile View for a person.
*JourneyApi* | [**deleteJourneyAction**](docs/JourneyApi.md#deleteJourneyAction) | **DELETE** /v1/journey/actions/{id} | Soft delete Journey Action.
*JourneyApi* | [**deleteProfileViewTemplate**](docs/JourneyApi.md#deleteProfileViewTemplate) | **DELETE** /v1/journey/views/templates | Delete Profile View Template
*JourneyApi* | [**getJourneyAction**](docs/JourneyApi.md#getJourneyAction) | **GET** /v1/journey/actions/{id} | Get specific Journey Action.
*JourneyApi* | [**getJourneyActionList**](docs/JourneyApi.md#getJourneyActionList) | **GET** /v1/journey/actions | Get all Journey Actions.
*JourneyApi* | [**getProfileViewTemplates**](docs/JourneyApi.md#getProfileViewTemplates) | **GET** /v1/journey/views/templates | Get Profile View Templates
*JourneyApi* | [**getReportByName**](docs/JourneyApi.md#getReportByName) | **GET** /v1/journey/reports/{reportname} | Get Report by Name
*JourneyApi* | [**getViewStatus**](docs/JourneyApi.md#getViewStatus) | **GET** /v1/journey/views | Get the status of a Progressive Profile View Job.
*JourneyApi* | [**postEvents**](docs/JourneyApi.md#postEvents) | **POST** /v1/journey/events | Post Events
*JourneyApi* | [**profileBuilder**](docs/JourneyApi.md#profileBuilder) | **POST** /v1/journey/profileview | A Profile is a bespoke view of a customer&#x27;s journey.
*JourneyApi* | [**readEvents**](docs/JourneyApi.md#readEvents) | **GET** /v1/journey/events | Read Events
*JourneyApi* | [**readEventsByIdentity**](docs/JourneyApi.md#readEventsByIdentity) | **GET** /v1/journey/events/{identity} | Read Events By Identity
*JourneyApi* | [**readStreams**](docs/JourneyApi.md#readStreams) | **GET** /v1/journey/streams | Read Streams
*JourneyApi* | [**readStreamsByPerson**](docs/JourneyApi.md#readStreamsByPerson) | **GET** /v1/journey/streams/{person} | Read Streams by Person
